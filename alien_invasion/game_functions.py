...
def check_play_button(ai_settings, screen, stats, sb, play_button, ship,
     ...
     if button_clicked and not stats.game_active:
         ...
         start_game(ai_settings, screen, stats, sb, play_button, ship,
                      aliens, bullets, mouse_x, mouse_y)
...
def update_screen(ai_settings, screen, stats, sb, ship, aliens, bullets,
    ...
    #Starts new level once aliens are destroyed. Creates new fleet 
...
def start_new_level(ai_settings, screen, stats,sb,ship,
                    aliens, bullets):
    """New level when all aliens are destroyed"""
    if len(aliens) == 0:
